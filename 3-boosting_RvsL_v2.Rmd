...
df_side <- list(oa_side = c(df_Roa$oa_side, df_Loa$oa_side),
                # Ipsilateral to OA
                Ipsi_Ankles_X = rbind(df_Roa$Ipsi_Ankles_X, df_Loa$Ipsi_Ankles_X),
                Ipsi_Knees_X = rbind(df_Roa$Ipsi_Knees_X, df_Loa$Ipsi_Knees_X),
                Ipsi_Hips_X = rbind(df_Roa$Ipsi_Hips_X, df_Loa$Ipsi_Hips_X),
                Ipsi_Spines_X = rbind(df_Roa$Ipsi_Spines_X, df_Loa$Ipsi_Spines_X),
                Ipsi_Necks_X = rbind(df_Roa$Ipsi_Necks_X, df_Loa$Ipsi_Necks_X),
                Ipsi_Shoulders_X = rbind(df_Roa$Ipsi_Shoulders_X, df_Loa$Ipsi_Shoulders_X),
                Ipsi_Elbows_X = rbind(df_Roa$Ipsi_Elbows_X, df_Loa$Ipsi_Elbows_X),
                Ipsi_Wrists_X = rbind(df_Roa$Ipsi_Wrists_X, df_Loa$Ipsi_Wrists_X),
                # Contralteral to OA
                Contr_Ankles_X = rbind(df_Roa$Contr_Ankles_X, df_Loa$Contr_Ankles_X),
                Contr_Knees_X = rbind(df_Roa$Contr_Knees_X, df_Loa$Contr_Knees_X),
                Contr_Hips_X = rbind(df_Roa$Contr_Hips_X, df_Loa$Contr_Hips_X),
                Contr_Spines_X = rbind(df_Roa$Contr_Spines_X, df_Loa$Contr_Spines_X),
                Contr_Necks_X = rbind(df_Roa$Contr_Necks_X, df_Loa$Contr_Necks_X),
                Contr_Shoulders_X = rbind(df_Roa$Contr_Shoulders_X, df_Loa$Contr_Shoulders_X),
                Contr_Elbows_X = rbind(df_Roa$Contr_Elbows_X, df_Loa$Contr_Elbows_X),
                Contr_Wrists_X = rbind(df_Roa$Contr_Wrists_X, df_Loa$Contr_Wrists_X))
